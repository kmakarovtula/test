...
WebUI.setText(findTestObject('LoggedOutPages/CreateAccount/BillingFirstName_Input'), 'Consumer')
...
WebUI.setText(findTestObject('LoggedOutPages/CreateAccount/CcNumber_Input'), CCNumberBase)
...
WebUI.setText(findTestObject('LoggedOutPages/CreateAccount/Email_Input'), EmailBase)

WebUI.setText(findTestObject('LoggedOutPages/CreateAccount/ConfirmEmail_Input'), EmailBase)

WebUI.setText(findTestObject('LoggedOutPages/CreateAccount/Password_Input'), PassBase)

WebUI.setText(findTestObject('LoggedOutPages/CreateAccount/ConfirmPassword_Input'), PassBase)
