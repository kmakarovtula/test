...
WebUI.setText(findTestObject('LoggedOutPages/CommonElements/Email_input'), EmailBase)

WebUI.setText(findTestObject('LoggedOutPages/CommonElements/Password_input'), PassBase)
