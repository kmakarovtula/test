...
OrderURL = WebUI.concatenate((([GlobalVariable.StagingReact, GlobalVariable.AffiliateURL, 'order/']) as String[]))
...
WebUI.callTestCase(findTestCase('Base Tests/OrderSignUpBase'), [('FirstName') : 'Affiliate', ('LastName') : 'Cadealer', ('Email') : Email
        , ('Phone') : '8001112233', ('Address') : 'test', ('City') : 'test', ('State') : 'CA', ('Zip') : '11111', ('CcNumber') : CCNumber
...
WebUI.verifyElementText(findTestObject('LoggedInPages/Order (react)/VtrPrice10'), Vtr10LoggedIn)

WebUI.verifyElementText(findTestObject('LoggedInPages/Order (react)/VtrPrice50'), Vtr50LoggedIn)
