...
WebUI.sendKeys(findTestObject('LoggedOutPages/CreateAccount/Email_Input'), Keys.chord(Keys.CONTROL, 'b'))

WebUI.verifyTextPresent('Salesman ID', false)

WebUI.verifyElementPresent(findTestObject('LoggedOutPages/CreateAccount/SalesmanID_Input'), 0)
