...
WebUI.click(findTestObject('LoggedInPages/Order (react)/SecondPricePoint'))

Price = WebUI.concatenate(((['Only ', Vtr2]) as String[]))
...
WebUI.verifyElementText(findTestObject('LoggedInPages/MyAccount/CreditsNumber'), '2')

WebUI.navigateToUrl(OrderURL)

WebUI.waitForElementVisible(findTestObject('LoggedInPages/Order (react)/VINCheckForm_EnterVINInput'), 0)

WebUI.setText(findTestObject('LoggedInPages/Order (react)/VINCheckForm_EnterVINInput'), VIN2)
...
WebUI.verifyElementText(findTestObject('LoggedInPages/Order (react)/Confirm_Price'), 'Only 1 Credit')

WebUI.verifyElementText(findTestObject('LoggedInPages/Order (react)/FirstPricePointPrice'), '2 Credits Left')
...
WebUI.waitForElementVisible(findTestObject('LoggedInPages/Order (react)/OrderSummary_BuyCreditsMessage'), 0)
...
WebUI.verifyElementText(findTestObject('LoggedInPages/Order (react)/ViewReport - Vin'), VIN2)

WebUI.navigateToUrl(MyAccountURL)

WebUI.verifyElementText(findTestObject('LoggedInPages/MyAccount/CreditsNumber'), '1')

WebUI.click(findTestObject('LoggedInPages/MyAccount/BillingHistorySideMenu_Tab'))

WebUI.waitForElementVisible(findTestObject('LoggedInPages/BillingHistory/Pager'), 0)

WebUI.verifyElementText(findTestObject('LoggedInPages/BillingHistory/FirstRow_Description'), '3 Credits')

WebUI.verifyElementNotPresent(findTestObject('LoggedInPages/BillingHistory/SecondRow_Description'), 0)
