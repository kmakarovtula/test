...
WebUI.setText(findTestObject('LoggedOutPages/CommonElements/Email_input'), '')

WebUI.setText(findTestObject('LoggedOutPages/CommonElements/Password_input'), 'WrongPassword')
...
WebUI.verifyElementText(findTestObject('LoggedOutPages/CommonElements/SignInErrors_Area'), 'Email is required')

WebUI.verifyElementAttributeValue(findTestObject('LoggedOutPages/CommonElements/Email_input'), 'class', 'error', 0)
