...
WebUI.verifyElementVisible(findTestObject('LoggedOutPages/HomeLoggedOut/DealerProgram_Link'))

WebUI.click(findTestObject('LoggedOutPages/HomeLoggedOut/DealerProgram_Link'))

WebUI.waitForElementVisible(findTestObject('LoggedOutPages/Dealers/SignUpTop_Button'), 0)

WebUI.verifyTextPresent('Welcome Dealers!', false)

WebUI.verifyTextPresent('Get more data to help make better decisions, including', false)
...
WebUI.selectOptionByValue(findTestObject('LoggedOutPages/CreateAccount/State_Dropdown'), 'TX', false)
...
ExpectedURL = WebUI.concatenate((([StartURL, '_O/dealer-bundles/order']) as String[]))
