...
WebUI.verifyElementText(findTestObject('LoggedInPages/Order (react)/RecordsAreAvailable_Alert'), 'Please enter a VIN to run a report.')
...
WebUI.verifyElementNotPresent(findTestObject('LoggedInPages/Order (react)/OrderNow_OrangeButton'), 0)
