...
WebUI.verifyElementAttributeValue(findTestObject('LoggedInPages/ReportSummary/ReportType'), 'class', 'ReportGrade AlertWarning', 
    0)

WebUI.verifyElementText(findTestObject('LoggedInPages/ReportSummary/ReportType'), 'Caution')
...
WebUI.verifyElementAttributeValue(findTestObject('LoggedInPages/ReportSummary/TitleStatus'), 'class', 'SummaryAlertContainer AlertWarning', 
    0)
...
WebUI.verifyElementText(findTestObject('LoggedInPages/ReportSummary/OdometerStatus'), '3events')
