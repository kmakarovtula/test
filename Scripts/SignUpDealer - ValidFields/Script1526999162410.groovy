...
WebUI.setText(findTestObject('LoggedOutPages/CreateAccount/FirstName_Input'), 'Dealer')
...
WebUI.setText(findTestObject('LoggedOutPages/CreateAccount/BillingFirstName_Input'), 'Dealer')
...
WebUI.verifyElementText(findTestObject('LoggedInPages/MyAccount/Account_Header'), 'For Dealer Test')
